...
import com.example.kweb.controller.http.model.ItemErrorMessage.ITEM_NAME_NOT_NULL
import com.example.kweb.controller.http.model.ItemErrorMessage.ITEM_NAME_SIZE
...
data class PostItemRequest(
    @field:NotNull(message = ITEM_NAME_NOT_NULL)
    @field:Size(min = 1, max = 200, message = ITEM_NAME_SIZE)
    @JsonProperty(ItemFieldName.ITEM_NAME)
    val itemName: String?,
